...
from goldenoxtari.components.interfaces import Reader
...
class FirecrawlReader(Reader):
    """
    FirecrawlReader uses the Firecrawl API to scrape or crawl websites and ingest them into Oxtari.
    """
    ...
    def __init__(self):
        ...
        self.name = "Firecrawl"
        self.type = "URL"
        self.description = "Use Firecrawl to scrape websites and ingest them into Oxtari"
        self.config = {
            "Mode": InputConfig(
                type="dropdown",
                value="Scrape",
